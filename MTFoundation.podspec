Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/xbydev/MTFoundation"
  ...
  s.author             = { "xiangby" => "xiangby87@gmail.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source       = { :git => "https://github.com/xbydev/MTFoundation.git", :tag => "#{s.version}" }
